...
class SignUpDemo extends StatelessWidget {
  static const String routeTitle = 'Sign Up';
  static const String routeName = '/demo/sign-up';
...
class _SignUpFormState extends State<SignUpForm> {
  ...
  _showWelcomeScreen() {
    Navigator.pushNamed(context, SignUpWelcomeScreen.routeName);
  }
}

class SignUpWelcomeScreen extends StatelessWidget {
  static const String routeTitle = 'Welcome';
  static const String routeName = '/demo/sign-up/welcome';
