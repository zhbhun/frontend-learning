...
document.querySelector("#settings #zoom").addEventListener(
  "click",
  function () {
...
document.querySelector("#settings #zoomIn").addEventListener(
  "click",
  function () {
...
document.querySelector("#settings #zoomOut").addEventListener(
  "click",
  function () {
...
document.querySelector("#settings #scrollTo").addEventListener(
  "click",
  function () {
    scroller.scrollTo(
      parseFloat(document.getElementById("scrollLeft").value),
      parseFloat(document.getElementById("scrollTop").value),
      true
    );
  },
  false
...
document.querySelector("#settings #scrollByUp").addEventListener(
  "click",
  function () {
...
document.querySelector("#settings #scrollByRight").addEventListener(
  "click",
  function () {
...
document.querySelector("#settings #scrollByDown").addEventListener(
  "click",
  function () {
    scroller.scrollBy(0, 150, true);
  },
...
document.querySelector("#settings #scrollByLeft").addEventListener(
  "click",
  function () {
    scroller.scrollBy(-150, 0, true);
  },
