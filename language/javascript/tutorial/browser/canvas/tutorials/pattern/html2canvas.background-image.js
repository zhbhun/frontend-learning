                    ...
                    case 4:
                      if (image) {
                        (_c = calculateBackgroundRendering(container, index, [
                          ...
                          (width = _c[3]),
                          (height = _c[4]);
                        scaleX_1 = width / image.naturalWidth;
                        scaleY_1 = height / image.naturalHeight;
                        pattern = this_1.ctx.createPattern(image, "repeat");
                        scaledPath = path.map(function (item) {
                          item.x = item.x / scaleX_1;
                          item.y = item.y / scaleY_1;
                          return item;
                        });
