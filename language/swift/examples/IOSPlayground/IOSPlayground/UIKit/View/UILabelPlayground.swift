...
class UILabelPlayground: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(LabelTableViewCell.self, forCellReuseIdentifier: cellIdentifier)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> LabelTableViewCell {
        // 为了避免样式冲突，这里选择不重用样式
        // let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as! LabelTableViewCell
        let cell = LabelTableViewCell(style: .default, reuseIdentifier: cellIdentifier)
