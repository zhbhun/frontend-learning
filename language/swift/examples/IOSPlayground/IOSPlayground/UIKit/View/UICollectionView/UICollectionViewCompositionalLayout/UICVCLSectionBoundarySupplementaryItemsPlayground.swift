...
class UICVCLSectionBoundarySupplementaryItemsPlayground: UIViewController {
...
extension UICVCLSectionBoundarySupplementaryItemsPlayground {
	/// - Tag: HeaderFooter
...
extension UICVCLSectionBoundarySupplementaryItemsPlayground: UICollectionViewDelegate {
