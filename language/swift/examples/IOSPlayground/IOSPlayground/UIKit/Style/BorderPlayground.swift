...
class BorderPlayground: UITableViewController {
	...
	override func viewDidLoad() {
		...
		tableView.register(BorderTableViewCell.self, forCellReuseIdentifier: cellIdentifier)
	}
	...
	override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> BorderTableViewCell {
		let cell = BorderTableViewCell(style: .default, reuseIdentifier: cellIdentifier)
