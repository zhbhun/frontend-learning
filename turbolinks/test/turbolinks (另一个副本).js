...
function() {
  ...
  Turbolinks.copyObject = function(t) {
    ...
    var t, n;
    return t = document.documentElement, null != (n = t.closest) ? n : function(t) {
      var n;
      for (n = this; n;) {
    ...
    var n, r, o, i, s;
    return i = null != e ? e : {}, s = i.target, n = i.cancelable, r = i.data, o = document.createEvent("Events"), o.initEvent(t, !0, n === !0), o.data = null != r ? r : {}, (null != s ? s : document).dispatchEvent(o), o
...
function() {
  ...
  Turbolinks.HttpRequest = function() {
    function e(e, n, r) {
      this.delegate = e, this.requestCanceled = t(this.requestCanceled, this), this.requestTimedOut = t(this.requestTimedOut, this), this.requestFailed = t(this.requestFailed, this), this.requestLoaded = t(this.requestLoaded, this), this.requestProgressed = t(this.requestProgressed, this), this.url = Turbolinks.Location.wrap(n).requestURL, this.referrer = Turbolinks.Location.wrap(r).absoluteURL, this.createXHR()
    }
...
function() {
  ...
  Turbolinks.BrowserAdapter = function() {
    ...
    var n, r, o, i;
    return i = Turbolinks.HttpRequest, n = i.NETWORK_FAILURE, o = i.TIMEOUT_FAILURE, r = 500, e.prototype.visitProposedToLocationWithAction = function(t, e) {
      return this.controller.startVisitToLocationWithAction(t, e)
    }, e.prototype.visitStarted = function(t) {
      return t.changeHistory(), t.issueRequest(), t.loadCachedSnapshot()
...
function() {
  ...
  t = !1, addEventListener("load", function() {
    ...
    return n.prototype.start = function() {
      ...
      var e, n, r, o;
      return this.shouldHandlePopState() && (o = null != (n = t.state) ? n.turbolinks : void 0) ? (e = Turbolinks.Location.wrap(window.location), r = o.restorationIdentifier, this.delegate.historyPoppedToLocationWithRestorationIdentifier(e, r)) : void 0
  ...
  Turbolinks.ElementSet = function() {
    function t(t) {
      ...
      this.elements = function() {
        var n, r, o;
        for (o = [], n = 0, r = t.length; r > n; n++) e = t[n], e.nodeType === Node.ELEMENT_NODE && o.push({
          element: e,
          value: e.outerHTML
        });
        return o
    ...
    return t.prototype.selectElementsMatchingSelector = function(t) {
      var e, n, r;
      return n = function() {
        var n, o, i, s, a;
        for (i = this.elements, a = [], n = 0, o = i.length; o > n; n++) s = i[n], e = s.element, r = s.value, Turbolinks.match(e, t) && a.push(e);
        return a
      }.call(this), new this.constructor(n)
    }, t.prototype.getElementsNotPresentInSet = function(t) {
      var e, n, r, o;
      return r = t.getElementIndex(), n = function() {
        var t, n, i, s, a;
        for (i = this.elements, a = [], t = 0, n = i.length; n > t; t++) s = i[t], e = s.element, o = s.value, o in r || a.push(e);
        return a
      }.call(this), new this.constructor(n)
    }, t.prototype.getElements = function() {
      var t, e, n, r, o;
      for (r = this.elements, o = [], e = 0, n = r.length; n > e; e++) t = r[e].element, o.push(t);
      return o
    }, t.prototype.getValues = function() {
      var t, e, n, r, o;
      for (n = this.elements, r = [], t = 0, e = n.length; e > t; t++) o = n[t].value, r.push(o);
      return r
    }, t.prototype.isEqualTo = function(t) {
      return this.toString() === (null != t ? t.toString() : void 0)
    }, t.prototype.toString = function() {
      return this.getValues().join("")
    }, t.prototype.getElementIndex = function() {
      var t, e, n;
      return null != this.elementIndex ? this.elementIndex : this.elementIndex = function() {
        var r, o, i, s;
        for (e = {}, i = this.elements, r = 0, o = i.length; o > r; r++) s = i[r], t = s.element, n = s.value, e[n] = t;
        return e
      }.call(this)
    }, t
  }()
...
function() {
  Turbolinks.Snapshot = function() {
    ...
    }, t.prototype.hasSameTrackedHeadElementsAsSnapshot = function(t) {
      return this.getTrackedHeadElementSet().isEqualTo(t.getTrackedHeadElementSet())
    }, t.prototype.getInlineHeadElementsNotPresentInSnapshot = function(t) {
      var e, n;
      return n = this.getInlineHeadStyleElementSet().getElementsNotPresentInSet(t.getInlineHeadStyleElementSet()), e = this.getInlineHeadScriptElementSet().getElementsNotPresentInSet(t.getInlineHeadScriptElementSet()), n.getElements().concat(e.getElements())
    }, t.prototype.getTemporaryHeadElements = function() {
    ...
    }, t.prototype.getTrackedHeadElementSet = function() {
      return null != this.trackedHeadElementSet ? this.trackedHeadElementSet : this.trackedHeadElementSet = this.getPermanentHeadElementSet().selectElementsMatchingSelector("[data-turbolinks-track=reload]")
    }, t.prototype.getInlineHeadStyleElementSet = function() {
      return null != this.inlineHeadStyleElementSet ? this.inlineHeadStyleElementSet : this.inlineHeadStyleElementSet = this.getPermanentHeadElementSet().selectElementsMatchingSelector("style")
    }, t.prototype.getInlineHeadScriptElementSet = function() {
      return null != this.inlineHeadScriptElementSet ? this.inlineHeadScriptElementSet : this.inlineHeadScriptElementSet = this.getPermanentHeadElementSet().selectElementsMatchingSelector("script:not([src])")
    }, t.prototype.getPermanentHeadElementSet = function() {
      return null != this.permanentHeadElementSet ? this.permanentHeadElementSet : this.permanentHeadElementSet = this.getHeadElementSet().selectElementsMatchingSelector("script, style, link[href], [data-turbolinks-track=reload]")
    }, t.prototype.getTemporaryHeadElementSet = function() {
      return null != this.temporaryHeadElementSet ? this.temporaryHeadElementSet : this.temporaryHeadElementSet = this.getHeadElementSet().getElementsNotPresentInSet(this.getPermanentHeadElementSet())
    }, t.prototype.getHeadElementSet = function() {
      return null != this.headElementSet ? this.headElementSet : this.headElementSet = new Turbolinks.ElementSet(this.head.childNodes)
    }, t
  }()
}.call(_this),
function() {
  Turbolinks.View = function() {
    ...
    return t.prototype.getRootLocation = function() {
      ...
      return e = (null != t ? t : {
        clone: !0
      }).clone, n = e ? this.element.cloneNode(!0) : this.element, Turbolinks.Snapshot.fromElement(n)
    }, t.prototype.render = function(t, e) {
      var n, r, o;
      return o = t.snapshot, n = t.html, r = t.isPreview, this.markAsPreview(r), null != o ? this.renderSnapshot(Turbolinks.Snapshot.wrap(o), e) : this.renderHTML(n, e)
      ...
      var n, o, s, a, l, u, c, h, p, d, f, y;
      if (n = this.getSnapshot({
          clone: !1
        }), !n.hasSameTrackedHeadElementsAsSnapshot(t)) return this.delegate.viewInvalidated(), !1;
      for (d = t.getInlineHeadElementsNotPresentInSnapshot(n), s = 0, u = d.length; u > s; s++) o = d[s], document.head.appendChild(o.cloneNode(!0));
      for (f = n.getTemporaryHeadElements(), a = 0, c = f.length; c > a; a++) o = f[a], document.head.removeChild(o);
      for (y = t.getTemporaryHeadElements(), l = 0, h = y.length; h > l; l++) o = y[l], document.head.appendChild(o.cloneNode(!0));
      return p = t.body.cloneNode(!0), this.delegate.viewWillRender(p), i(p), document.body = p, r(), "function" == typeof e && e(), this.delegate.viewRendered()
    }, t.prototype.renderHTML = function(t, n) {
      return document.documentElement.innerHTML = t, e(), "function" == typeof n && n(), this.delegate.viewRendered()
    }, i = function(t) {
      var e, n, r, i, s, a;
      for (s = o(document.body), a = [], e = 0, n = s.length; n > e; e++) r = s[e], (i = t.querySelector("[id='" + r.id + "']")) ? a.push(i.parentNode.replaceChild(r, i)) : a.push(void 0);
      return a
    }, o = function(t) {
      return t.querySelectorAll("[id][data-turbolinks-permanent]")
    }, e = function() {
      var t, e, r, o, i, s;
      for (i = document.querySelectorAll("script"), s = [], t = 0, e = i.length; e > t; t++) o = i[t], r = n(o), s.push(o.parentNode.replaceChild(r, o));
      return s
    }, n = function(t) {
      var e;
      return e = document.createElement("script"), t.hasAttribute("src") ? e.src = t.getAttribute("src") : e.textContent = t.textContent, e
    }, r = function() {
      var t;
      return null != (t = document.body.querySelector("[autofocus]")) ? t.focus() : void 0
    }, t
  }()
}.call(_this),
function() {
...
function() {
  Turbolinks.Cache = function() {
    ...
    return t.prototype.has = function(t) {
      ...
      var n, r;
      return r = e(t), n = this.keys.indexOf(r), n > -1 && this.keys.splice(n, 1), this.keys.unshift(r), this.trim()
...
function() {
  ...
  Turbolinks.Visit = function() {
    function e(e, n, r) {
      this.controller = e, this.action = r, this.performScroll = t(this.performScroll, this), this.identifier = Turbolinks.uuid(), this.location = Turbolinks.Location.wrap(n), this.adapter = this.controller.adapter, this.state = "initialized", this.timingMetrics = {}
    }
    var n;
    return e.prototype.start = function() {
...
function() {
  ...
  Turbolinks.Controller = function() {
      ...
      return e.prototype.start = function() {
        ...
        var n, r;
        return null == e && (e = {}), t = Turbolinks.Location.wrap(t), this.applicationAllowsVisitingLocation(t) ? this.locationIsVisitable(t) ? (n = null != (r = e.action) ? r : "advance", this.adapter.visitProposedToLocationWithAction(t, n)) : window.location = t : void 0
      }, e.prototype.startVisitToLocationWithAction = function(t, e, n) {
        var r;
        return Turbolinks.supported ? (r = this.getRestorationDataForIdentifier(n), this.startVisit(t, e, {
          restorationData: r
        })) : window.location = t
        ...
        var t;
        return this.shouldCacheSnapshot() ? (this.notifyApplicationBeforeCachingSnapshot(), t = this.view.getSnapshot(), this.cache.put(this.lastRenderedLocation, t)) : void 0
        ...
        var r, o, i, s, a;
        return o = null != n ? n : {}, s = o.restorationIdentifier, i = o.restorationData, r = o.historyChanged, a = new Turbolinks.Visit(this, t, e), a.restorationIdentifier = null != s ? s : Turbolinks.uuid(), a.restorationData = Turbolinks.copyObject(i), a.historyChanged = r, a.referrer = this.location, a
      }, e.prototype.visitCompleted = function(t) {
