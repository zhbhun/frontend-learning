...
const ComponentExamples: Array<UIExplorerExample> = [
  ...
  */
  {
    key: 'ActivityIndicatorExample',
    module: require('./components/ActivityIndicatorExample'),
  },
  {
    key: 'ButtonExample',
    module: require('./components/ButtonExample'),
  },
  {
    key: 'DrawerLayoutAndroidExample',
    module: require('./components/DrawerLayoutAndroidExample'),
  },
  {
    key: 'ImageExample',
    module: require('./components/ImageExample'),
  },
  {
    key: 'KeyboardAvoidingViewExample',
    module: require('./components/KeyboardAvoidingViewExample'),
  },
  {
    key: 'ModalExample',
    module: require('./components/ModalExample'),
  },
  {
    key: 'NavigatorExample',
    module: require('./components/NavigatorExample'),
  },
  {
    key: 'WebViewExample',
    module: require('./components/WebViewExample'),
  },
];
...
const CommunityExamples: Array<UIExplorerExample> = [
  {
    key: 'react-native-vector-icons',
    module: require('./communities/react-native-vector-icons')
  },
];
...
APIExamples
.concat(ComponentExamples)
.concat(CommunityExamples)
.forEach(Example => {
  const { key, module } = Example;
  Modules[key] = module;
  (function submodule(examples, path) {
    examples && examples.forEach((item, i) => {
      const key = `${path}.${i}`;
      Modules[key] = item;
      submodule(item.examples, key);
    });
  })(module.examples, key);
});
