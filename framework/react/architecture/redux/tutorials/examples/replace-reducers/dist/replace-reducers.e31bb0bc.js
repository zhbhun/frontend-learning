...
var __ = function __() {
  ...
  if (action.type === '@@INIT' || action.type === _redux.__DO_NOT_USE__ActionTypes.REPLACE || action.type === _redux.__DO_NOT_USE__ActionTypes.INIT) {// return {
    //   ts: Date.now(),
    // };
  }
...
var reducers1 = (0, _redux.combineReducers)({
  __: __,
  home: homeReducer,
  detail: detailReducer
});
var store = (0, _redux.createStore)(reducers1, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
console.log(store.getState());
setTimeout(function () {
  // app come back to hoem page from detail page
  // new reducers remove detail reducer, but detail state is still in store
  var reducers2 = (0, _redux.combineReducers)({
    __: __,
    home: detailReducer
  });
...
},{"redux":"node_modules/redux/es/redux.js"}],"../../../../../../../../../../.nvm/versions/node/v8.11.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/replace-reducers.e31bb0bc.map