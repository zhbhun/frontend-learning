import { ElementaryCalculator, DeleteCommand, OperandCommand, OperatorCommand, NumberOperand, Multiply, Plus, Equal, } from './index';
...
console.log('>> undo 2 steps:', calculator.toString(), '=', calculator.compute());
calculator.redo().redo();
console.log('>> redo 2 steps:', calculator.toString(), '=', calculator.compute());
calculator.press(new DeleteCommand()).press(new DeleteCommand());
console.log('>> delete 2 input:', calculator.toString(), '=', calculator.compute());
calculator.undo().undo();
console.log('>> undo 2 steps:', calculator.toString(), '=', calculator.compute());
